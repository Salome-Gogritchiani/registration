document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('registration-form').addEventListener('submit', function(event) {
        ...
        if (!validatePassword(password)) {
            document.getElementById('password-error').textContent = 'პაროლი არ აკმაყოფილებს მოთხოვნებს.';
            isValid = false;
        }
        ...
        if (isEmailUsed(email)) {
            document.getElementById('email-error').textContent = 'მეილი უკვე გამოყენებულია.';
            isValid = false;
        }
